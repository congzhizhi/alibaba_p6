package NIO.VIPIO.luban.第一讲.luban.testdome;
...
public class Test2 {
    ...
    public static Integer synchronization(int a,int b){
        int c=a+b;
        return c;
    }

    public static void synchronization(Monitor monitor,int a,int b){
        int c=a+b;
        monitor.returnMethod(c);
    }

    public static void synchronization2(Monitor2 monitor,int a,int b){
        int c=a+b;
