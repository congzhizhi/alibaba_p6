 ...
 */
package com.luban.netty.nettySelfProtocol.codec;

import com.luban.netty.nettySelfProtocol.struct.Header;
import com.luban.netty.nettySelfProtocol.struct.NettyMessage;
...
public class TestCodeC {
	...
	byte[] a = new byte[4];
	ByteBuffer nuf = ByteBuffer.wrap(a );
	...
	Header header = new Header();
	header.setCrcCode(in.readerIndex(0).readInt());
