package com.luban.netty.lbrpc.client.netty;

import com.luban.netty.lbrpc.entity.ClassInfo;
    ...
    public static Object create(final Class clazz){
        return Proxy.newProxyInstance(clazz.getClassLoader(), new Class[]{clazz}, new InvocationHandler() {
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                //创建业务处理类
                final ClientSocketNettyHendler nettyClientHendler = new ClientSocketNettyHendler();
                try {
