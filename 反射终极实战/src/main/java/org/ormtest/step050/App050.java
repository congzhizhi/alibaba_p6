...
public class App050 {
    ...
    private void start() throws Exception {
        ...
        // 数据库连接地址
        String dbConnStr = "jdbc:mysql://localhost:3306/mybatis?user=root&password=123456&characterEncoding=utf-8&useSSL=false&serverTimezone=Hongkong";
        // 创建数据库连接
        ...
        // 创建 SQL 查询
        String sql = "select * from ormtest limit 20000";
